...
function NewComputerModal({ onClose, openPopUp, getComputers }) {
  ...
  const createComputer = async () => {
    setIsLoading(true);
    const msg = await computerServices.createComputer(description);
  ...
  return (
    <Modal onClick={(e) => exitModal(e)} id="modal">
      <Container>
        ...
        <button onClick={createComputer}>Criar</button>
...
export default NewComputerModal;
